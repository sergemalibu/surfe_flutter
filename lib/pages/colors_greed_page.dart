...
class ColorGrid extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    //фильтрация
    final filteredColors = _colorsData.colors[_colors]
        ?.where((color) => color[_value] != null)
        .toList();
    return Padding(
          ...
          Expanded(
            child: GridView.builder(
              ...
              itemBuilder: (BuildContext context, int index) {
                ...
                var colorName = color?[_name];
                var colorValue = color?[_value];
